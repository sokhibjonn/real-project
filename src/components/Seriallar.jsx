...
import Paketlar from "./Paketlar";

export default function Seriallar() {
    const [posts, setPosts] = useState([]);

    useEffect(() => {
        axios.get('http://localhost:9000/serial')
    ...
    return (
        <div className="new container">
            <div className="row">
                <div className="col-md-8"><h1 className="newFor mt-5">O'zbek seriallari </h1></div>
                <div className="col-sm-4 text-end"> <Link to="/forserial"><Button className="wierd mt-5">Barchasi <img className="small" src={Image} alt="" /></Button></Link></div>
            </div>
