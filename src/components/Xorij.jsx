...
export default function Xorij() {
    ...
    return (
        <div className="new container">
            <div className="row">
                <div className="col-md-8"><h1 className="newFor mt-5">Xorij seriallar </h1></div>
                <div className="col-sm-4 text-end">
                    <Link to="/forxorij"><Button className="wierd mt-5">Barchasi <img className="small" src={Image} alt="" /></Button></Link></div>
            </div>
